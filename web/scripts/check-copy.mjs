...
// The copy lives in the shared package: one set of strings serves web and
// mobile, so the voice is guarded in one place for both.
const RESOURCES = join(root, '../packages/core/src/i18n/resources.ts')
