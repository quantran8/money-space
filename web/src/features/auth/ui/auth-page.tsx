...
export function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <main className="min-h-screen bg-canvas text-ink antialiased">
      <div className="mx-auto flex min-h-screen w-full max-w-[1360px] items-stretch px-5 py-5 sm:px-7 sm:py-7 lg:px-8 lg:py-8">
        <div className="grid w-full gap-5 lg:grid-cols-[1.08fr_.92fr] lg:gap-8">
          <AuthBrandPanel />

          <section className="flex items-center justify-center">
            <div className="w-full max-w-[500px] rounded-card bg-card px-6 py-8 sm:px-8 sm:py-8 lg:px-12 lg:py-12">
              <AuthMobileHeader />
              {children}
            </div>
          </section>
