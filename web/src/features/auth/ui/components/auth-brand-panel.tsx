...
export function AuthBrandPanel() {
  ...
  return (
    <section className="hidden min-h-[720px] flex-col justify-between px-3 py-2 lg:flex">
      <AuthLogo markClassName="size-11 rounded-[12px] bg-card" className="t-subhead" />

      <div className="max-w-[650px] pb-8">
        <p className="mb-5 t-body-sm font-medium text-action">{t('auth.brand.eyebrow')}</p>

        <h1 className="max-w-[630px] t-hero leading-[1.08] tracking-[-0.035em]">
          {t('auth.brand.titleLine1')}
          <br />
          {t('auth.brand.titleLine2')}
        </h1>

        <p className="mt-6 max-w-[580px] t-body leading-7 text-ink2">
      ...
      <div className="mb-2 flex flex-wrap items-center gap-x-6 gap-y-3 t-body-sm text-ink2">
