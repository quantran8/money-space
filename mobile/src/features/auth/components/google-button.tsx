 ...
 * Sign in with Google.
 *
 * Its own control rather than a `Button` variant: the kit's Button takes a
 * string child, and this one carries Google's four-colour mark, which their
 * branding rules do not allow us to recolour.
 */
...
/** The "hoặc" rule between Google and the email form. */
