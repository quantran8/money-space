...
Sản phẩm là một app dành cho các cặp đôi **25–37 tuổi, sắp cưới hoặc đã cưới**, giúp hai người cùng có một bức tranh tài chính rõ ràng và hiểu trước hệ quả của các quyết định tài chính quan trọng.
...
**Money today → Money location → Upcoming cash-flow → Protected money → Flexible money → What-if decision → Goal impact → Shared understanding**
...
**Hiểu consequence trước khi quyết định.**

---

## 5. Core Business Hypothesis
...
> **“Tôi muốn biết sắp tới có ổn không.”**

User trả tiền vì:

> **“Tôi muốn hiểu consequence của các lựa chọn tài chính trước khi quyết định.”**
...
> **Hai người có cùng một bức tranh tài chính đủ rõ để cùng xây các mục tiêu lớn, và đủ thông tin để hiểu hệ quả trước những quyết định quan trọng.**
