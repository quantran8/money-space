  ...
  vi: {
    translation: {
      ...
      shell: {
        ...
        guest: 'Khách',
        // Trang Cài đặt là nơi đăng xuất trên mobile, sau khi bỏ drawer.
      ...
      assets: {
        ...
        demo: {
          ...
          // Standalone labels: the web strip states these as their own tiles,
          // so the value is no longer interpolated into the sentence.
          totalAssetsLabel: 'Tổng tài sản',
          totalDebtLabel: 'Tổng nợ',
        ...
        summary: {
          ...
          total: 'Tổng tài sản',
          dayChange: 'Hôm nay {{value}}',
          changeSince: 'Từ {{date}} {{value}}',
          // The pill states the amount on its own, so these carry only the
          // period the amount is measured over.
          dayChangeSuffix: 'so với hôm qua',
          changeSinceSuffix: 'so với {{date}}',
          dayChangePartial: '({{count}} khoản chưa có mốc so sánh)',
        },
        charts: {
        ...
        detail: {
          ...
          hero: {
            ...
            dayChange: 'Thay đổi hôm nay',
            changeSince: 'Thay đổi từ {{date}}',
            performance: 'Hiệu suất',
            share: 'Tỷ trọng',
            shareOfPortfolio: 'Tỷ trọng danh mục',
      ...
      whatif: {
        ...
        shortfall: {
          ...
          // Dòng mở đầu bước bán: nói thẳng khoản thiếu trước khi hỏi bán gì.
          lead: 'Tiền có thể dùng ngay còn thiếu {{amount}} cho khoản chi này.',
          // Bán hết mọi thứ vẫn không tới — nêu sự thật, không gợi ý bán.
          beyondAssets:
            'Còn thiếu {{amount}}. Bán toàn bộ tài sản có thể bán cũng chỉ được khoảng {{sellable}}, nên khoản chi này chưa nằm trong khả năng hiện tại.',
          noAssets: 'Còn thiếu {{amount}} và chưa có tài sản nào có thể bán để bù.',
        },
        assetSale: {
          // Nêu một lựa chọn để thử, không khuyên nên bán (§Voice).
          cta: 'Thử bán một phần tài sản',
          title: 'Thử bán một phần tài sản',
          description: 'Mô phỏng số tiền nhận về. Không ghi nhận giao dịch.',
          asset: 'Tài sản bán',
          ...
          proceedsEstimate: 'Thu về ước tính',
          ...
          back: 'Quay lại',
          // Bước bán mở thẳng sau khi biết thiếu tiền, nên nút này là đường ra
          // của người không muốn bán — vẫn xem được kết quả gốc.
          skip: 'Xem kết quả không bán',
          remove: 'Bỏ phần bán',
      ...
      events: {
        ...
        byCategory: {
          title: 'Theo nhóm',
          // Khối này luôn đọc cả tháng, không đổi theo bộ lọc người/loại/tìm
          // kiếm ở danh sách bên dưới — nói rõ để không ai hiểu nhầm hai số
          // đang mô tả cùng một tập.
          meta: 'Cả tháng',
          outflow: 'Tiền ra',
          inflow: 'Tiền vào',
          total: 'Tổng',
          share: '{{percent}}%',
          recordCount: '{{count}} sự kiện',
          uncategorized: 'Chưa phân nhóm',
          others: '{{count}} nhóm khác',
          emptyOutflow: 'Chưa có khoản chi nào trong tháng này.',
          emptyInflow: 'Chưa có khoản thu nào trong tháng này.',
        },
        byMember: {
          // "Phụ trách" — ai đứng tên khoản đó, không phải "ai tiêu" (§0.2,
          // §16.4). Cùng cách gọi với card "Ai đang phụ trách?" ở Home.
          title: 'Theo người phụ trách',
          moneyIn: 'Tiền vào',
          moneyOut: 'Tiền ra',
          // Khoản không ghi ai phụ trách thì thuộc về cả nhà, không gán bừa.
          unassigned: 'Cả nhà',
          recordCount: '{{count}} sự kiện',
          empty: 'Chưa có sự kiện nào trong tháng này.',
        },
        review: {
          eyebrow: 'Cần xem lại',
      ...
      settings: {
        ...
        categories: {
          ...
          addDescription: 'Chọn biểu tượng, màu và đặt tên để dễ nhận biết khi nhập giao dịch.',
          nameLabel: 'Tên hiển thị',
          namePlaceholder: 'Ví dụ: Ăn uống',
          nameHint: 'Tên sẽ hiển thị trong danh sách và bộ lọc giao dịch.',
    ...
    translation: {
      ...
      assets: {
        ...
        summary: {
          ...
          changeSince: 'Since {{date}} {{value}}',
          dayChangeSuffix: 'vs yesterday',
          changeSinceSuffix: 'vs {{date}}',
          dayChangePartial: '({{count}} without a baseline)',
        },
        charts: {
        ...
        detail: {
          ...
          hero: {
            ...
            share: 'Allocation',
            shareOfPortfolio: 'Portfolio allocation',
      ...
      whatif: {
        ...
        shortfall: {
          ...
          lead: 'Money you can use right away is {{amount}} short of this spend.',
          beyondAssets:
            '{{amount}} short. Selling every sellable asset raises about {{sellable}}, so this spend is out of reach right now.',
          noAssets: '{{amount}} short, and there is nothing here that could be sold to cover it.',
        },
        assetSale: {
          cta: 'Try selling part of an asset',
          title: 'Try selling part of an asset',
          description: 'Estimate the cash raised. No transaction is recorded.',
          asset: 'Asset to sell',
          ...
          proceedsEstimate: 'Estimated proceeds',
          ...
          back: 'Back',
          skip: 'See the result without selling',
      ...
      events: {
        ...
        byCategory: {
          ...
          total: 'Total',
          share: '{{percent}}%',
          recordCount: '{{count}} events',
          uncategorized: 'Uncategorized',
          others: '{{count}} more groups',
          emptyOutflow: 'Nothing was spent this month yet.',
          emptyInflow: 'Nothing came in this month yet.',
        },
        byMember: {
          ...
          recordCount: '{{count}} events',
          empty: 'Nothing recorded this month yet.',
        },
        review: {
      ...
      settings: {
        ...
        categories: {
          ...
          addDescription: 'Choose an icon and color, then name it for quick recognition when adding transactions.',
          nameLabel: 'Display name',
          namePlaceholder: 'e.g. Dining',
          nameHint: 'This name appears in transaction lists and filters.',
          iconLabel: 'Icon',
          chooseIcon: 'Choose',
          ...
          colorLabel: 'Color',
          customColor: 'Pick another color',
