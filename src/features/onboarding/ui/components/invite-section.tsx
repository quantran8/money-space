...
export function InviteSection({ register, error, invalid }: InviteSectionProps) {
  ...
  return (
    <section className="rounded-3xl border border-[hsl(var(--border))] bg-sunk p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="shrink-0 rounded-full bg-[hsl(var(--card))] px-2.5 py-1 text-xs font-medium text-ink2 shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
