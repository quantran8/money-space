...
export function useHouseholdInvite() {
  ...
  async function renew() {
    ...
    try {
      ...
      toast.success(t('invites.qr.renewed'))
    } catch (cause) {
      toast.error(getErrorMessage(cause, t('invites.qr.error')))
    }
  }
  ...
  async function copyLink() {
    ...
    try {
      ...
      toast.success(t('invites.qr.copied'))
    } catch {
      toast.error(t('invites.qr.copyFailed'))
    }
  }
