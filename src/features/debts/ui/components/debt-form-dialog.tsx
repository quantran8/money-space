                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <div className="mt-2 flex flex-wrap justify-end gap-2">
                      ...
                      <button type="button" onClick={pasteAmountFromClipboard} className="rounded-lg px-3 py-1.5 text-xs font-semibold text-accent">
                        Dán số tiền
                      </button>
                    </div>
                  </div>
